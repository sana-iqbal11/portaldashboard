  ...
  const handleSetNewPassword = async () => {
    try {
      ...
      const response = await fetch(`${BASE_URL}users/reset-password`, {
        ...
        body: JSON.stringify({
          email: 'ujalakhan.isb@gmail.com',
          password: values.newPassword,
          token:
            'CfDJ8Ny9UpHVVMFIjMjFY2YHp//XNFqzWhyv6RNag5GKPHjoa1ppyOSfoxFd04XzWsWMJWjYgjfmM6zTrZcB/MF4ub8o0DOgqBx4OM1/g6VbU2crvYDPlAuggoRe8wyRfD1gVnCMLrU77p0AGeREPUFmQb+u5MYeds3RUXGFIRkxt8omUpqKZTj7vuHopA1FpTQ+HuGHNZBfx6EK3HKK8O4w5T+Ts+zkV9ivKLwP3519Kal6'
        })
      })
      ...
      if (response.ok) {
        ...
        toast.error('Password not reset successfully')
      }
    } catch (error) {
        ...
        >
          <Box sx={{ width: '100%', maxWidth: 400 }}>
            ...
            <form noValidate autoComplete='off' onSubmit={e => e.preventDefault()}>
              ...
              />
              <Button fullWidth type='submit' variant='contained' sx={{ mb: 4 }} onClick={handleSetNewPassword}>
                Set New Password
              </Button>
