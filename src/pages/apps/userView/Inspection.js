...
const Inspection = () => {
  ...
  const data = [
    { id: 147, questionnaire: 'ITS AVM Inspection Form', site: 'Ad-Diriyah 505', date: '2023-12-23 12:15:04' },
    { id: 147, questionnaire: 'ITS AVM Inspection Form', site: 'Hitteen 606', date: '2023-12-23 12:15:04' },
    { id: 147, questionnaire: 'ITS AVM Inspection Form', site: 'Hitteen 606', date: '2023-12-23 12:15:04' }
  ]
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: ({ row }) => <Typography sx={{ color: 'text.secondary' }}>{row.questionnaire}</Typography>
    },
    {
      flex: 0.1,
      minWidth: 100,
      field: 'site',
      headerName: 'Site',
      renderCell: ({ row }) => <Typography sx={{ color: 'text.secondary' }}>{row.site}</Typography>
    },
