...
const UserDropdown = props => {
  ...
  const imageAvatar = `${userData?.imageUrl}`
    ...
    <Fragment>
      ...
      >
        <Avatar
          ...
          src={imageAvatar}
          onClick={handleDropdownOpen}
          sx={{ width: 38, height: 38, backgroundColor: theme => theme.palette.primary.skin }}
        />
      </Badge>
      <Menu
        anchorEl={anchorEl}
      ...
      >
        <Box sx={{ py: 1.75, px: 6 }}>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            >
              <Avatar alt={fullName} src={imageAvatar} sx={{ width: '2.5rem', height: '2.5rem' }} />
            </Badge>
